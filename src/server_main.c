...
int main() {
    ...
    waiting_client_t *waiting_list = NULL;  // Lista de espera vacía.
    rooms *rooms_list = NULL;               // Lista de salas vacía.
    ...
    while (1) {
        ...
        if(empty_room){
            ...
            snprintf(temp_data, sizeof(temp_data), "NO|%d|%s", turn, initial_info);
        }
